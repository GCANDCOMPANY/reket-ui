...
const Modal = ({
  ...
  const modalContentStyle = mergeStyle(
    `absolute left-[50%] z-10 max-h-[80vh] translate-x-[-50%] transform overflow-auto bg-white shadow transition-transform md:rounded-lg max-md:rounded-t-lg max-md:bottom-0 max-md:w-full md:top-[50%] md:min-w-[448px] md:translate-y-[-50%]`,
    className,
  );
